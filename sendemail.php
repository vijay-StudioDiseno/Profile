...
if($_POST)
{
	$to_Email   	= "vijaybernadsha.s@gmail.com"; //Replace with recipient email address
	$subject        = 'Vijay Reply'; //Subject line for emails
	...
	$sentMail = @mail($user_email, $subject, 'Hi '.$user_name .','."\n"."\n".' Thank you. Your message is very important to me, I will Update your request as soon as i can ...', $headers2);
	...
	if(!$sentMail)
	{
		...
		$output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_name .','.' Thank you,.  Your message is very important to me, I will Update your request as soon as i can ...'));
		die($output);
	}
}
?>